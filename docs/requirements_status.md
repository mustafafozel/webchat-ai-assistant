...
| Mini knowledge base | `knowledge/kb.json` ve `backend/rag_setup.py` içinde JSON yükleyicisi ve `mini_rag_search` fonksiyonu bulunur. | `knowledge/kb.json`, `backend/rag_setup.py` |
